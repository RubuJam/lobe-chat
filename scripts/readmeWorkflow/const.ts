...
export const MARKET_URL = 'https://edu.oaknuts.me/market';
export const PLGUIN_URL = 'https://chat-preview.lobehub.com/settings/agent';
export const AGENT_EN_URL = 'https://chat-agents-edu.oaknuts.me/index.json';
export const AGENT_CN_URL = 'https://chat-agents-edu.oaknuts.me/index.zh-CN.json';
