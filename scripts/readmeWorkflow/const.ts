...
export const MARKET_URL = 'https://edu.rubuark.live/market';
export const PLGUIN_URL = 'https://chat-preview.lobehub.com/settings/agent';
export const AGENT_EN_URL = 'https://chat-agents-edu.rubuark.live/index.json';
export const AGENT_CN_URL = 'https://chat-agents-edu.rubuark.live/index.zh-CN.json';
